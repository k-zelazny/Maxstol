    ...
    <div class="card-block block-promo">
      <div class="cart-voucher">
        ...
        <div class="promo-code" id="promo-code">
          <span class="voucher-info">{l s='Gift card, voucher, or promo code' d='Maxstol.Theme.Checkout'}</span>
          ...
          {block name='cart_voucher_form'}
            <form method="post">
              ...
              <div class="promo-input-button d-f">
                <input class="promo-input" type="text" name="discount_name" aria-label="{l s='Promo code' d='Shop.Theme.Checkout'}">
                <button data-link-action="x-add-voucher" type="submit" class="btn btn-primary"><span>{l s='Apply' d='Maxstol.Theme.Checkout'}</span></button>
              </div>
            </form>
          {/block}
        </div>
