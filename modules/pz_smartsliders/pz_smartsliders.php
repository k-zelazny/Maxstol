...
class Pz_Smartsliders extends Module implements WidgetInterface
{
  public function __construct()
  {
    $this->name = 'pz_smartsliders';
    ...
    $this->displayName = $this->trans('Smart Sliders', [], 'Modules.Pzsmartsliders.Admin');
    $this->description = $this->trans('...', [], 'Modules.Pzsmartsliders.Admin');
  ...
  public function install()
  {
    return parent::install()
      ...
      && $this->registerHook('displayRXSmartSliders');
  }
