...
class Pz_Googlereviews extends Module implements WidgetInterface
{
  public function __construct()
  {
    $this->name = 'pz_googlereviews';
    ...
    $this->displayName = $this->trans('Google Reviews', [], 'Modules.Pzgooglereviews.Admin');
    $this->description = $this->trans('...', [], 'Modules.Pzgooglereviews.Admin');
  ...
  public function install()
  {
    return parent::install()
      ...
      && $this->registerHook('displayPZGoogleReviews');
  }
