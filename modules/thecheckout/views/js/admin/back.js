...
// on domcontent loaded, add to body classes psversion-xxx, where xxx is in JS variable _PS_VERSION_ - if it's not, do not set it
$(document).ready(function () {
    if (typeof _PS_VERSION_ !== "undefined") {
        $('body').addClass('psversion-' + _PS_VERSION_.replace(/\./g, ''));
    }
});